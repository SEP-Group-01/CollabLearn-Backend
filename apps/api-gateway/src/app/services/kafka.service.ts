...
export class KafkaService implements OnModuleInit {
  ...
  async onModuleInit() {
    ...
    const replyTopics = [
      ...
      'document-query.query-documents.reply',
      'document-query.get-conversations.reply',
      'document-query.get-conversation-messages.reply',
      'document-query.create-conversation.reply',
