...
export class QueryController {
    ...
    async searchDocuments(@Body() body: any) {
        ...
        try {
            const response = await this.kafkaService.sendMessage('document-query.search-documents', body);
            return response;
        } catch (error) {
            throw new HttpException(
    ...
    async getDocumentSummary(@Body() body: any) {
        ...
        try {
            const response = await this.kafkaService.sendMessage('document-query.get-document-summary', body);
            return response;
        } catch (error) {
            throw new HttpException(
